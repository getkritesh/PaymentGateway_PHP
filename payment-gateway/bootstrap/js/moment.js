...
(function (factory) {
    ...
    var months = 'leden_�nor_brezen_duben_kveten_cerven_cervenec_srpen_z�r�_r�jen_listopad_prosinec'.split('_'),
        monthsShort = 'led_�no_bre_dub_kve_cvn_cvc_srp_z�r_r�j_lis_pro'.split('_');
    ...
    function translate(number, withoutSuffix, key, isFuture) {
        ...
        case 'MM': // 9 months / in 9 months / 9 months ago
            if (withoutSuffix || isFuture) {
                return result + (plural(number) ? 'mes�ce' : 'mes�cu');
            } else {
...
(function (factory) {
    ...
    return moment.defineLocale('cv', {
        months : '?a????_???a?_???_???_???_�e????_??a_�????_??a?_???_???_??????'.split('_'),
        monthsShort : '?a?_???_???_???_???_�e?_??a_�??_??_???_???_???'.split('_'),
        weekdays : '???????????_????????_?????????_?????_?e�????????_???????_?a??????'.split('_'),
        weekdaysShort : '???_???_???_??_?e�_???_?a?'.split('_'),
        weekdaysMin : '??_??_??_??_?�_??_??'.split('_'),
        longDateFormat : {
            LT : 'HH:mm',
            LTS : 'LT:ss',
            L : 'DD-MM-YYYY',
            LL : 'YYYY [�????] MMMM [??a?e?] D[-?e?e]',
            LLL : 'YYYY [�????] MMMM [??a?e?] D[-?e?e], LT',
            LLLL : 'dddd, YYYY [�????] MMMM [??a?e?] D[-?e?e], LT'
        },
        calendar : {
            sameDay: '[????] LT [???????]',
            nextDay: '[????] LT [???????]',
...
(function (factory) {
    ...
    return moment.defineLocale('hr', {
        months : 'sjecanj_veljaca_o�ujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split('_'),
...
(function (factory) {
    ...
    weekDays = 'sekmadienis_pirmadienis_antradienis_treciadienis_ketvirtadienis_penktadienis_�e�tadienis'.split('_');
    ...
    return moment.defineLocale('lt', {
        months : 'sausio_vasario_kovo_baland�io_gegu�es_bir�elio_liepos_rugpjucio_rugsejo_spalio_lapkricio_gruod�io'.split('_'),
...
(function (factory) {
    ...
    var units = {
        ...
        'MM': 'menesi_mene�us_menesis_mene�i',
